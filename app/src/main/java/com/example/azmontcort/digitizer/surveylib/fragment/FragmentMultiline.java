package com.example.azmontcort.digitizer.surveylib.fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button_continue.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                 Answers.getInstance().put_answer(textview_q_title.getText().toString(), editText_answer.getText().toString().trim()); // KEY (PREGUNTA) + VALUE (RESPUESTA)
                ((SurveyActivity) mContext).go_to_next(); // ACA TOMA LA RESPUESTA DE ESTE TIPO DE PREGUNTA
            }
        });
